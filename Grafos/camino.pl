/*
	GRAFOS NO DIRIGIDOS
	grado(+listaVertices, +listaAristas)

	grafo([a, b, c], [arista(a,b), arista(a,c)]

*/

/*
	camino(+Inicio, +Fin, +Grafo, +Visitados, -Camino)
		es cierto si Camino unifica con una lista de aristas/vértices
		que va desde Inicio hasta Fin sin repetir las aritas/vértices
